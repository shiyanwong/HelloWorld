...
namespace BetterFarmAnimalVariety.Framework.Helpers
{
    class Mod
    {
        ...
        {
            return PariteeCore.Utilities.Mod.ReadConfig<T>(ModEntry.Instance.Helper.DirectoryPath, Constants.Mod.ConfigFileName);
        }
        ...
        {
            return PariteeCore.Utilities.Mod.LoadTexture(Path.Combine(ModEntry.Instance.Helper.DirectoryPath, filePath));
        }
