...
namespace BetterFarmAnimalVariety
{
    ...
    {
        // Unofficial Update notes by mouseypounds
        // - Added a static instance in order to access Helper from other classes, spacechase-style (sorry Pathos)
        // - Changed all the PariteeCore.Utilities.Mod.Path calls to instead use SMAPI's API to get the directory
        // - Changed Harmony patches for cross-compatibility
        // - Suppress error about animal product objects not existing
